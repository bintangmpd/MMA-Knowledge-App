...
class MuaytaiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_muaytai)
...
//        val judul5 = findViewById<VideoView>(R.id.judul5)
        ...
        val videoUri1 = Uri.parse("android.resource://" + packageName + "/" + R.raw.muaythai_clichknee)
        val videoUri2 = Uri.parse("android.resource://" + packageName + "/" + R.raw.muaythai_elbow)
        val videoUri3 = Uri.parse("android.resource://" + packageName + "/" + R.raw.muaythai_highelbow)
        val videoUri4 = Uri.parse("android.resource://" + packageName + "/" + R.raw.muaythai_highknee)
        val videoUri5 = Uri.parse("android.resource://" + packageName + "/" + R.raw.muaythai_spinningelbow)
