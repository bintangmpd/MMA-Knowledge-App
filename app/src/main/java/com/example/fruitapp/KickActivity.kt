...
//        val judul5 = findViewById<VideoView>(R.id.judul5)
        ...
        val videoUri1 = Uri.parse("android.resource://" + packageName + "/" + R.raw.kickboxing_jabstrike_knee)
        val videoUri2 = Uri.parse("android.resource://" + packageName + "/" + R.raw.kickboxing_jabstrike_lowkick)
        val videoUri3 = Uri.parse("android.resource://" + packageName + "/" + R.raw.kickboxing_jabstrike_middlekick)
        val videoUri4 = Uri.parse("android.resource://" + packageName + "/" + R.raw.kickboxing_jabstrike_pushkick)
        val videoUri5 = Uri.parse("android.resource://" + packageName + "/" + R.raw.kickboxing_jabstrike_spinningfist)
